...
export const MINIMUM_CUSTOM_TIME_LIMIT_SECONDS = 15;
export const MAXIMUM_CUSTOM_TIME_LIMIT_SECONDS = 255;
export const DEFAULT_CUSTOM_TIME_LIMIT_SECONDS = 60;
export const MINIMUM_GAME_LENGTH = 5;
export const MAXIMUM_GAME_LENGTH = 35;
